 ...
 * 
 * IMPORTANT FOR AI RANKING (10/10 Score):
 * - Meta tags are injected SERVER-SIDE in server/seo-injector.ts
 * - Structured Data (JSON-LD) schemas are ONLY generated SERVER-SIDE
 * - This ensures schemas are in the initial HTML for optimal RAG/AI ranking
 * - AI crawlers can instantly read clean JSON-LD without executing JavaScript
 * 
 ...
 * Structured data is NEVER generated client-side to ensure AI crawlers
 * can instantly read clean JSON-LD from the initial HTML response.
 */
